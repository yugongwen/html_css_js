			...
			<div id=formTable>
				<table style="width: 100%">
					<tr>
						...
						<td>
						 <%--  <ww:select name="sysid"  value="sysid" list="@com.css.admin.sys.service.SystemService@getAvailabeSystems().resultObject" listKey="systemId" listValue="sysname" hint="----请选择----"/>
						  --%>
						  <ww:panelCheck id="sysid"  value="sysid" list="@com.css.admin.sys.service.SystemService@getAvailabeSystems().resultObject" listKey="systemId" listValue="sysname" cols="2"/>  
						</td>
						</tr>
				...
				<table>
					...
					<ww:iterator value="page.results">
						<tr>
							...
							<td align="center">
								<ww:property value="@com.css.admin.sys.service.SystemService@getSystem(sysid).resultObject.sysname()"/>
							</td>
							<td align="left">
