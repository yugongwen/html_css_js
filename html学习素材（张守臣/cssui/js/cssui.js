  ...
  $.fn.cssTab = function(parameters) {
    ...
    module = {
      addTab: function(params) {
        ...
        if ($('#' + params.id)[0]) {
        	var $a  = $ul.find('[href="#' + params.id + '"]');
        	if(params.refresh+''=='true') {
        		$a.data('loaded', 0);
        	}
			if(!! params.url){
				$a.attr('data-href',params.url);
			}
			if(!! params.title){
				$a.find('span').html(params.title);
				$more.next().find('li').eq(module._indexTabId($a.attr('tabid'))).find('a').html(params.title);
			}
			$a.click();
            return;
        }
...
(function($, window, document, undefined) {
  ...
  $.fn.cssTable = function(parameters) {
	...
	titleMap = {
		...
		delLeaderSche : '你确定要删除这条日程吗？',
		delBatchLeaderSche : '你确定要删除这些日程吗？',
		delSche : '你确定要删除这条日程吗？',
		delBatchSche : '你确定要删除这些日程吗？',
		release : '你确定要发布这条日程吗？',
		releaseBatch : '你确定要发布这些日程吗？',
		disRelease : '你确定不发布这条日程吗？',
		disReleaseBatch : '你确定不发布这些日程吗？',
		cancelRelease : '你确定要取消发布这条日程吗？',
		cancelReleaseBatch : '你确定要取消发布这些日程吗？',
		subLeaderSche : '你确定要提交这条日程吗？',
		subBatchLeaderSche : '你确定要提交这些日程吗？',
		subSche : '你确定要提交这条日程吗？',
		subBatchSche : '你确定要提交这些日程吗？'
	};
    module = {
      getCheck:function(){
      ...
      delBatchSche:function(params){
  		var ids=$css.checkedVal('ids',$module);
  		if(ids.length>0){
  		   var url,title = titleMap.delBatchSche;
  			if (typeof(params) === 'string')
  			  url=params;
  			else{
  			  url=params.url;
        ...
        delBatchLeaderSche:function(params){
      		var ids=$css.checkedVal('ids',$module);
      		if(ids.length>0){
      		   var url,title = titleMap.delBatchLeaderSche;
      			if (typeof(params) === 'string')
      			  url=params;
      			else{
      			  url=params.url;
      ...
      releaseBatch:function(params){
        ...
        disReleaseBatch:function(params){
      		var ids=$css.checkedVal('ids',$module);
      		if(ids.length>0){
      		   var url,title = titleMap.disReleaseBatch;
      			if (typeof(params) === 'string')
      			  url=params;
      			else{
      			  url=params.url;
        ...
        subBatchSche:function(params){
      		var ids=$css.checkedVal('ids',$module);
      		if(ids.length>0){
      		   var url,title = titleMap.subBatchSche;
      			if (typeof(params) === 'string')
      			  url=params;
      			else{
      			  url=params.url;
        ...
        subBatchLeaderSche:function(params){
      		var ids=$css.checkedVal('ids',$module);
      		if(ids.length>0){
      		   var url,title = titleMap.subBatchLeaderSche;
      			if (typeof(params) === 'string')
      			  url=params;
      			else{
      			  url=params.url;
      ...
      delSche:function(params){
  		var url,title = titleMap.delSche;
  		if (typeof(params) === 'string')
  		  url=params;
  		else{
  		  url=params.url;
        ...
        delLeaderSche:function(params){
      		var url,title = titleMap.delLeaderSche;
      		if (typeof(params) === 'string')
      		  url=params;
      		else{
      		  url=params.url;
      ...
      release:function(params){
        ...
        disRelease:function(params){
      		var url,title = titleMap.disRelease;
      		if (typeof(params) === 'string')
      		  url=params;
      		else{
      		  url=params.url;
        ...
        subSche:function(params){
      		var url,title = titleMap.subSche;
      		if (typeof(params) === 'string')
      		  url=params;
      		else{
      		  url=params.url;
        ...
        subLeaderSche:function(params){
      		var url,title = titleMap.subLeaderSche;
      		if (typeof(params) === 'string')
      		  url=params;
      		else{
      		  url=params.url;
